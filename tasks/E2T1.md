# E2T1 — Implement /roll command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DICE

Add /roll command to generate random 1-6 using random.randint(1,6), atomically increment counter in transaction, and reply with 'You rolled: X'. Write tests/specs/E2T1.json with BotSpec tests for /roll response and counter increment. Append /roll to tests/commands.json.
