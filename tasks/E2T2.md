...
Write unit tests for /roll handler: mock Telegram update, verify dice result (1-6), verify counter increments by 1. Write integration tests for /roll command in tests/specs/E2T2.json.
