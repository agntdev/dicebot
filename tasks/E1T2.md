# E1T2 — Add /count command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DICE

Implement /count command to reply with current counter value (e.g., 'Total rolls served: 123'). Write tests/specs/E1T2.json with BotSpec tests for /count response. Append /count to tests/commands.json.
